class TrackEditor {
    ...
    loadTrackParts() {
        ...
        parts.forEach(part => {
            ...
            partElement.innerHTML = `
                <img src="assets/track-parts/${part.image}" alt="${part.name}">
                <span>${part.name}</span>
            `;
    ...
    drawTrack() {
        ...
        this.trackParts.forEach(part => {
            const img = new Image();
            img.src = `assets/track-parts/${part.type.toLowerCase()}.png`;
            img.onload = () => {
                this.ctx.drawImage(
                    img,
                    part.col * cellSize,
    ...
    generateRandomTrack() {
        ...
        const partTypes = ['Straight', 'Curve', 'Cross', 'Start'];
